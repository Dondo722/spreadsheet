...
public class SearchBoxController {
    ...
    protected static void setController(SearchBox searchBox, SpreadsheetModel model){
        table = new Table<>(searchBox.getSceneWidth(),Teacher.getNames().length,Teacher.getNames(),Teacher.getNamesVal());
    ...
    private static void nameSearchBoxFind(SearchBox searchBox,SpreadsheetModel model){
        ...
        if (nameBox.getDepartmentName() == null &&  nameBox.getTeacherName().getText().equals(""))AlertBox.display();
        else {
    ...
    private static void rankSearchBoxFind(SearchBox searchBox,SpreadsheetModel model){
        ...
        ObservableList<Teacher> teachers = FXCollections.observableArrayList();
        if (rankBox.getRankBoxVal() == null && rankBox.getFacultyBoxVal()== null)AlertBox.display();
        else {
    ...
    private static void expSearchBoxFind(SearchBox searchBox,SpreadsheetModel model){
        ...
        ObservableList<Teacher> teachers = FXCollections.observableArrayList();
        if (expBox.getFromVal() == null || expBox.getToVal()== null)AlertBox.display();
        else {
